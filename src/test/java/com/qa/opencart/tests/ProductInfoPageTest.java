...
public class ProductInfoPageTest extends BaseTest {
	// Pvrecodition is that user should be login for AccountsPage
	...
	public void productInfoTest() {
		...
		// SoftAssertion
		// here mutiple assertion so if one got fail all test case will get fail so use
		// soft assert created softassert obejct in BaseTest class
